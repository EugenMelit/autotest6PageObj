...
class ResizablePage(BasePage):
    ...
    def get_max_and_min_size(self, element):
        ...
        # берем значения высоты и ширины элемента
        size_value = size.get_attribute('style')
        return size_value

    def change_size_resizable_box(self):
        # изменяем размеры окна по заданным координатам
    ...
    def change_size_resizable(self):
        # изменяем размеры окна по заданным координатам случайным образом,в пределах окна браузера

...
class RadioButtonPagesLocators:
   YES_RADIOBUTTON = (By.CSS_SELECTOR, 'label[class^="custom-control"][for="yesRadio"]')
   NO_RADIOBUTTON = (By.CSS_SELECTOR, 'label[class^="custom-control"][for="noRadio"]')
   IMPRESSIV_RADIOBUTTON = (By.CSS_SELECTOR, 'label[class^="custom-control"][for="impressiveRadio"]')
   OUTPUT_RESULT = (By.CSS_SELECTOR, 'p span[class="text-success"]')

class  WebTablesPagesLocators:
    # person
...
class DynamicPropertyPageLocators:

    COLORS_CHANGE_BUTTON = (By.CSS_SELECTOR, 'button[id="colorChange"]')
